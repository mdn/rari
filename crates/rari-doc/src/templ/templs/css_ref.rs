...
pub fn css_ref() -> Result<String, DocError> {
    ...
    //     ('C', "Reference/Values/counter", "<counter>"),
    //     ('U', "Reference/Values/url_value", "url()"),
    //     ('I', "Reference/Values/initialinherit", "inherit"),
    //     ('I', "Reference/Values/initial", "initial"),
    //     ('R', "Reference/Values/revert", "revert"),
    //     ('U', "Reference/Values/unset", "unset"),
...
fn adjust_output<'a>(url: Cow<'a, str>, label: Cow<'a, str>) -> (Cow<'a, str>, Cow<'a, str>) {
    ...
    let url = match label.as_ref() {
        ...
        // Image
        "image()" => Cow::Borrowed("Reference/Values/image#The_image()_functional_notation"),
        "image-set()" | "paint()" => Cow::Owned(concat_strs!(
            "Reference/Values/image/",
        ...
        // Colors
        "rgba()" => return (Cow::Borrowed("Reference/Valuescolor_value/rgb"), label),
        "hsla()" => return (Cow::Borrowed("Reference/Values/color_value/hsl"), label),
